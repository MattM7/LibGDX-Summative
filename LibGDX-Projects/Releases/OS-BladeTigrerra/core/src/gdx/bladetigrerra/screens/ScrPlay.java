//2.1 Blade Tigrerra: Hero becomes animated
package gdx.bladetigrerra.screens;
...
import gdx.bladetigrerra.utils.TiledObjectUtil;
import gdx.bladetigrerra.utils.CameraStyleUtil;
import gdx.bladetigrerra.SpriteExtended;
import gdx.bladetigrerra.utils.Lights;
...
public class ScrPlay extends ApplicationAdapter implements Screen {
    ...
    public ScrPlay(Game _game) {
        ...
        sprExtHero = new SpriteExtended("Vlad.png", bodyPlayer.getPosition().x, bodyPlayer.getPosition().y);
