...
import gdx.exedra.*;
import gdx.exedra.utils.CameraStyleUtil;
import gdx.exedra.utils.ContactListenerUtil;
import gdx.exedra.utils.Lights;

import java.util.ArrayList;
import java.util.Iterator;

import static gdx.exedra.utils.Constants.fPPM;
import static gdx.exedra.utils.Constants.fSCALE;
...
public class ScrPlay extends ApplicationAdapter implements Screen {
    ...
    //------------------------------------ CONSTRUCTOR ----------------------------------------
    public ScrPlay(GamExedra _game) {
        int nX = 0, nY = 0;
