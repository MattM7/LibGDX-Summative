...
import gdx.juggernoid.TbMenu;
import gdx.juggernoid.TbsMenu;
...
public class ScrMenu implements Screen, InputProcessor {
    ...
    //------------------------------------ CONSTRUCTOR ----------------------------------------
    public ScrMenu(GamJuggernoid _game) {  //Referencing the main class.
        game = _game;
    }
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(0, 0, 1, 1); //Green background.
    ...
    private void btnPlayListener() {
        tbPlay.addListener(new ChangeListener() {
            public void changed(ChangeEvent event, Actor actor) {
                ...
                game.alSoundEffects.get(0).play();
            }
        });
    }
