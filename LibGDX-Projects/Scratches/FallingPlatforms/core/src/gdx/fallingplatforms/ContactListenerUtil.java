...
public class ContactListenerUtil implements ContactListener {
    ...
    public void beginContact(Contact cntct) {
        ...
        if (isHitMoving(a, b)) {
            PlayerBox pA = (PlayerBox) a.getUserData();
            KinematicBox kB = (KinematicBox) b.getUserData();
            kB.bHit = true;
            System.out.println("hit a moving plat");
    ...
    private boolean isHitMoving(Fixture a, Fixture b) {
        if (a.getUserData() instanceof PlayerBox || b.getUserData() instanceof PlayerBox) {
            if (a.getUserData() instanceof KinematicBox || b.getUserData() instanceof KinematicBox) {
                return true;
            }
        }
        return false;
